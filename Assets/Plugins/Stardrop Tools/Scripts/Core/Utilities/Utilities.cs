...
public static class Utilities
{
    ...
    /// </summary>
    public static void Initialize(params IInitialize[] initializeables)
    {
    ...
    /// </summary>
    public static void Initialize(List<IInitialize> initializeables)
    {
        if (initializeables.Exists())
    ...
    /// </summary>
    public static void LateInitialize(ILateInitialize[] lateInitializeables)
    {
    ...
    /// </summary>
    public static void LateInitialize(List<ILateInitialize> lateInitializers)
    {
    ...
    public static T[] GetRandomNonRepeatWithMin<T>(this T[] array, int minAmount)
    {
        ...
        return GetRandomNonRepeat(array, amount).ToArray();
    }
    ...
    public static T[] GetComponentArrayInChildren<T>(this Transform parent)
    {
        if (parent != null)
        {
            T[] componentArray = GetComponentListInChildren<T>(parent)?.ToArray();
