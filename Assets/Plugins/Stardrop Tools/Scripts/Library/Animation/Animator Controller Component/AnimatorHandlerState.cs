...
{
    [System.Serializable]
    public class AnimatorHandlerState
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        public AnimatorHandlerState()
        {
            crossfade = .15f;
        }

        public AnimatorHandlerState(string stateName, int stateHash, int layer, float crossfadeTime, float animLength)
        {
        ...
        public AnimatorHandlerState(string stateName, int layer, string transitionName, float crossfadeTime, float animLength)
        {
            this.stateName = stateName;
            this.layer = layer;
